...
public class Message extends Packet {
	...
	/**
	 * Returns the default subject of the message, or null if the subject has not
	 * been set. The subject is a short description of message contents.
	 * <p>
	...
	/**
	 * Returns the subject corresponding to the language. If the language is null,
	 * the method result will be the same as {@link #getSubject()}. Null will be
	 * returned if the language does not have a corresponding subject.
	 * 
	 * @param language
	...
	public void setSubject(String subject) {
		if (subject == null) {
			removeSubject(""); // use empty string because #removeSubject(null) is
													// ambiguous
			return;
		}
	 ...
	 * <p>
	 * The default body of a message is the body that corresponds to the message's
	 * language. (see {@link #getLanguage()}) or if no language is set to the
	 * applications default language (see {@link Packet#getDefaultLanguage()}).
	 * 
	...
	/**
	 * Returns a set of all bodies in this Message, including the default message
	 * body accessible from {@link #getBody()}.
	 * 
	 ...
	 * sequence of "chat" messages. If no thread id is set, <tt>null</tt> will be
	 * returned.
	 * 
	...
	private String determineLanguage(String language) {
		...
		// empty string is passed by #setSubject() and #setBody() and is the same as
		// null
	...
	public String toXML() {
		...
		if (channel != null) {
			buf.append(" channel=\"").append(StringUtils.escapeForXML(channel))
					.append("\"");
		}
		if (typeString != null) {
			buf.append(" type=\"").append(StringUtils.escapeForXML(typeString))
					.append("\"");
		}
		if (cid != null) {
			buf.append(" cid=\"").append(StringUtils.escapeForXML(cid)).append("\"");
		}
		if (sid != null) {
